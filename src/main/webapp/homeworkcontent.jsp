...
<body>
	...
	<div class="login">
		<table width="60%" border=1 class="hovertable">
			...
			<tbody>
				<%
				String u1 = (String) request.getSession().getAttribute("user_id");
				List<StudentHomework> a1 = (List<StudentHomework>) request.getAttribute("sh");
				List<Homework> h2 = (List<Homework>) request.getAttribute("h2");
